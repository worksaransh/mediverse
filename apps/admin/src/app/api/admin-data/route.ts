...
import { createDb, contentItems, users, profiles, streaks, aiMessages, platformSettings } from "@mediverse/db";
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      ingestionSources,
      communityLinks: settings?.value || defaultLinks,
    });
